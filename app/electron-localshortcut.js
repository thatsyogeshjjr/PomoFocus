...
const isAccelerator = require("./electron-is-accelerator/index");
const equals = require("./keyboardevents-areequal/index");
const { toKeyEvent } = require("./keyboardevent-from-electron-accelerator/index");
